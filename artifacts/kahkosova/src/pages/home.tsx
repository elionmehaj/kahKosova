    ...
    <MainLayout>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-white/80 text-sm mb-6 backdrop-blur-md">
              ...
              Serving the global diaspora
            </div>
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-display font-bold leading-[1.1] mb-6">
              Your Digital <br/>
              <span className="text-gradient-primary">Bridge to Kosovo.</span>
            </h1>
            <p className="text-lg sm:text-xl text-white/70 mb-10 max-w-2xl leading-relaxed">
              Manage land, handle bureaucracy, and support family from anywhere in the world. Secure, transparent, and built for the diaspora.
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 mt-16 pt-8 border-t border-white/10">
              <div>
                ...
                <p className="text-sm text-white/50">Families Served</p>
              </div>
              <div>
                <p className="text-3xl font-display font-bold text-white mb-1">12</p>
                <p className="text-sm text-white/50">Municipalities</p>
              </div>
              <div>
      ...
      <section className="py-24 bg-card relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-display font-bold text-white mb-4">Core Services</h2>
            <p className="text-white/60 max-w-2xl mx-auto">Everything you need to maintain your ties and assets in Kosovo, simplified into one platform.</p>
          </motion.div>
          ...
          >
            ...
            <motion.div variants={fadeIn} className="bg-background rounded-2xl p-8 border border-white/5 hover:border-primary/30 transition-all duration-300 group hover:-translate-y-1 shadow-lg">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Toka / Land</h3>
              <p className="text-white/60 mb-6 leading-relaxed">
                Lease or manage your properties back home securely. Track payments and find trusted local partners.
              </p>
            ...
            <motion.div variants={fadeIn} className="bg-background rounded-2xl p-8 border border-white/5 hover:border-primary/30 transition-all duration-300 group hover:-translate-y-1 shadow-lg">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Familja / Gifting</h3>
              <p className="text-white/60 mb-6 leading-relaxed">
                Send groceries, gifts, and essentials to your family directly through trusted local vendors.
              </p>
            ...
            <motion.div variants={fadeIn} className="bg-background rounded-2xl p-8 border border-white/5 hover:border-primary/30 transition-all duration-300 group hover:-translate-y-1 shadow-lg">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Letrat / Bureaucracy</h3>
              <p className="text-white/60 mb-6 leading-relaxed">
                Generate bilingual legal forms and access our comprehensive checklist for returning to Kosovo.
              </p>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="glass-panel rounded-3xl p-8 md:p-16 text-center max-w-4xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl font-display font-bold text-white mb-6">Pay-as-you-go, No Hidden Fees</h2>
            <p className="text-lg text-white/70 mb-10 max-w-2xl mx-auto">
              We believe in complete transparency. Our services are priced clearly upfront. Only pay for the forms, transactions, or listings you actually use.
            </p>
            <div className="flex flex-wrap justify-center gap-6">
              <div className="flex items-center gap-2 text-white/80 bg-white/5 px-4 py-2 rounded-lg border border-white/10">
                <Globe className="w-5 h-5 text-primary" /> Multi-currency support
              </div>
              <div className="flex items-center gap-2 text-white/80 bg-white/5 px-4 py-2 rounded-lg border border-white/10">
                <Clock className="w-5 h-5 text-primary" /> Instant delivery
              </div>
            </div>
          </div>
        </div>
